               ...
               <div className='' key={Math.random()}>
                 ...
                 <div className="grid grid-cols-4 gap-7">
                 {
                  categories.videos.map((video)=>{
                    return(
                        <Link to={`/${getdata.courseId}/${video.videoId}`} key={video.videoId} className="mainCard pb-[60px] relative rounded-2xl bg-white border-2 border-yellow-500 overflow-hidden">
